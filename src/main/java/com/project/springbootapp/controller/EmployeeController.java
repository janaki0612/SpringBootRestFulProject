...
public class EmployeeController {
	...
	//build rest api to save an employee
	@PostMapping()
	...
	//build rest api to retrieve all employee
	@GetMapping()
	...
	//build rest api for getting employee details by ID
	@GetMapping("{id}")
	...
	//build rest api for updating employee details by ID 
	@PutMapping("{id}")
